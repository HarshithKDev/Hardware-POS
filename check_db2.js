...
async function check() {
  ...
  console.log("bills.id type via RPC:", bills);
  
  // Since we can't do pg_typeof easily via js select, let's query a known view if accessible, but we can't.
  // We can just try an invalid insert and look at the error.
