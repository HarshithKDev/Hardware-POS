  ...
  return (
    <div className="h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div className={`border border-gray-400 bg-[#f9f9f9] p-5 border-l-4 rounded-none shadow-sm ${lowStoreCount > 0 ? 'border-l-[#e81123]' : 'border-l-[#0078D7]'}`}>
        ...
        <div className={`border border-gray-400 bg-[#f9f9f9] p-5 border-l-4 rounded-none shadow-sm ${lowWarehouseCount > 0 ? 'border-l-[#e81123]' : 'border-l-[#0078D7]'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="border border-gray-400 bg-white p-5 border-l-4 border-l-[#107c10] rounded-none shadow-sm">
