    ...
    return (
      <div className="min-h-screen bg-[#0078D7] flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md bg-white p-8 border border-gray-400 shadow-[2px_2px_0px_rgba(0,0,0,0.2)] rounded-none">
          <h2 className="text-2xl font-light text-black mb-2">System Registration</h2>
          <p className="text-gray-600 mb-6 text-sm">Initialize your POS system.</p>
          <form onSubmit={handleSetup} className="space-y-4">
            ...
            <button type="submit" disabled={isSettingUp} className="w-full py-3 bg-[#0078D7] hover:bg-[#005a9e] text-white text-lg font-medium transition-colors rounded-none border border-[#005a9e] disabled:opacity-50">{isSettingUp ? 'Saving...' : 'Register System'}</button>
          </form>
        </div>
      </div>
    );
