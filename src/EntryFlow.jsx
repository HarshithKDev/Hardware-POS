...
// SVG (Scalable Vector Graphics) components for the Eye and Eye-slash icons
const EyeIcon = () => (
...
export default function EntryFlow({ onLoginSuccess, isSetupNeeded, onSetupComplete, shopSettings }) {
  ...
  // States to toggle (switch) password visibility
        ...
        <div className="w-full max-w-md bg-white p-8 border border-gray-400 shadow-[2px_2px_0px_rgba(0,0,0,0.2)] rounded-none">
          ...
          <form onSubmit={handleSetup} className="space-y-4">
            ...
            <div className="relative">
              ...
              {/* tabIndex="-1" prevents the browser from focusing on the eye icon when pressing the Tab key */}
